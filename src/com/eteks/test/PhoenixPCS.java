...
public class PhoenixPCS extends Plugin 
{
	...
	{		
		...
		public float PLACEMENT_TOLERANCE = 4.0f;	// 2cm
			...
			{			
				...
				try
				{
					...
					if(bSuccess)
					{
						...
						saveDesign(home, pcsRect.getName());
		...
		public void checkAndSnap(HomePieceOfFurniture hpRef, List<WallSegement> inWSList, float tolr)
		{
